package com.louis.EazySchool.model;

import com.louis.EazySchool.annotation.FieldsValueMatch;
...
@FieldsValueMatch.List({
        ...
        @FieldsValueMatch(
                ...
                message = "Email addresses do not march"
        )
})
...
public class Person extends BaseEntity {
    ...
    @JoinColumn(name = "class_id", referencedColumnName = "classId", nullable = true) // No cascade from person to class
